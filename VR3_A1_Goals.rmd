...
Still, 80-90% of my time is spent scrubbing, formatting, and validating data. The data lives in SQL databases or MS Excel worksheets. For visualization - I use Tableau for financial and sales dashboards and TreeMap©  <http://www.treemap.com/> for telecom  analyses. 
...
| Data Prep                               | R                                       |
+-----------------------------------------+-----------------------------------------+
| Using the tools I know for visualiztion | Phython                                 |
+-----------------------------------------+-----------------------------------------+
| Finding patterns in the underlying data | English                                 |
+-----------------------------------------+-----------------------------------------+
